...
"""autogenerated by genpy from dobot/SetJOGCoordinateParamsRequest.msg. Do not edit."""
import sys
...
class SetJOGCoordinateParamsRequest(genpy.Message):
  _md5sum = "56415298907749fc622f73f4a2f4c767"
  _type = "dobot/SetJOGCoordinateParamsRequest"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetJOGCoordinateParamsRequest, self).__init__(*args, **kwds)
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dobot/SetJOGCoordinateParamsResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class SetJOGCoordinateParamsResponse(genpy.Message):
  _md5sum = "cbf7b461449133eb5dd6ebbd8d38dedc"
  _type = "dobot/SetJOGCoordinateParamsResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(SetJOGCoordinateParamsResponse, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
...
def _get_struct_iQ():
    ...
    return _struct_iQ
class SetJOGCoordinateParams(object):
  _type          = 'dobot/SetJOGCoordinateParams'
  _md5sum = '66026db026b6b1016fb4eccdf054b1ba'
  _request_class  = SetJOGCoordinateParamsRequest
  _response_class = SetJOGCoordinateParamsResponse
