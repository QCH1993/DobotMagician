...
class SetJOGCoordinateParamsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetJOGCoordinateParamsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetJOGCoordinateParamsRequest
    let len;
    let data = new SetJOGCoordinateParamsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetJOGCoordinateParamsRequest(null);
...
class SetJOGCoordinateParamsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetJOGCoordinateParamsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetJOGCoordinateParamsResponse
    let len;
    let data = new SetJOGCoordinateParamsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetJOGCoordinateParamsResponse(null);
...
module.exports = {
  Request: SetJOGCoordinateParamsRequest,
  Response: SetJOGCoordinateParamsResponse,
  md5sum() { return '66026db026b6b1016fb4eccdf054b1ba'; },
  datatype() { return 'dobot/SetJOGCoordinateParams'; }
};
