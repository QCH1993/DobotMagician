...
class SetARCParamsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetARCParamsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetARCParamsRequest
    let len;
    let data = new SetARCParamsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetARCParamsRequest(null);
...
class SetARCParamsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetARCParamsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetARCParamsResponse
    let len;
    let data = new SetARCParamsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetARCParamsResponse(null);
...
module.exports = {
  Request: SetARCParamsRequest,
  Response: SetARCParamsResponse,
  md5sum() { return '667693b23f3c212883d158fa88cec8f5'; },
  datatype() { return 'dobot/SetARCParams'; }
};
