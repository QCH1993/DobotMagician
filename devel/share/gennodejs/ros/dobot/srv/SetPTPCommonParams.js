...
class SetPTPCommonParamsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPTPCommonParamsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPTPCommonParamsRequest
    let len;
    let data = new SetPTPCommonParamsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPTPCommonParamsRequest(null);
...
class SetPTPCommonParamsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPTPCommonParamsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPTPCommonParamsResponse
    let len;
    let data = new SetPTPCommonParamsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPTPCommonParamsResponse(null);
...
module.exports = {
  Request: SetPTPCommonParamsRequest,
  Response: SetPTPCommonParamsResponse,
  md5sum() { return '07fac5c7832f03b11ac295e63e130ee0'; },
  datatype() { return 'dobot/SetPTPCommonParams'; }
};
