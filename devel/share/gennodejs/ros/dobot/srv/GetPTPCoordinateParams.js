...
class GetPTPCoordinateParamsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPTPCoordinateParamsRequest
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPTPCoordinateParamsRequest
    let len;
    let data = new GetPTPCoordinateParamsRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPTPCoordinateParamsRequest(null);
    return resolved;
    }
};

class GetPTPCoordinateParamsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPTPCoordinateParamsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPTPCoordinateParamsResponse
    let len;
    let data = new GetPTPCoordinateParamsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPTPCoordinateParamsResponse(null);
...
module.exports = {
  Request: GetPTPCoordinateParamsRequest,
  Response: GetPTPCoordinateParamsResponse,
  md5sum() { return '886db9a7d126004f299ba6b6878cb966'; },
  datatype() { return 'dobot/GetPTPCoordinateParams'; }
};
