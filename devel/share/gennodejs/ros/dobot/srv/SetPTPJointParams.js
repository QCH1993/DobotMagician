...
class SetPTPJointParamsRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPTPJointParamsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPTPJointParamsRequest
    let len;
    let data = new SetPTPJointParamsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPTPJointParamsRequest(null);
...
class SetPTPJointParamsResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.result = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SetPTPJointParamsResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SetPTPJointParamsResponse
    let len;
    let data = new SetPTPJointParamsResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetPTPJointParamsResponse(null);
...
module.exports = {
  Request: SetPTPJointParamsRequest,
  Response: SetPTPJointParamsResponse,
  md5sum() { return '66026db026b6b1016fb4eccdf054b1ba'; },
  datatype() { return 'dobot/SetPTPJointParams'; }
};
