...
class GetIODORequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetIODORequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetIODORequest
    let len;
    let data = new GetIODORequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetIODORequest(null);
...
class GetIODOResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetIODOResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetIODOResponse
    let len;
    let data = new GetIODOResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetIODOResponse(null);
...
module.exports = {
  Request: GetIODORequest,
  Response: GetIODOResponse,
  md5sum() { return '658a016d9c03f31ccbdb869e836cf420'; },
  datatype() { return 'dobot/GetIODO'; }
};
