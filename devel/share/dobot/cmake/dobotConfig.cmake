...
if(NOT "/home/qch/dobot_ws/devel/include " STREQUAL " ")
  set(dobot_INCLUDE_DIRS "")
  set(_include_dirs "/home/qch/dobot_ws/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dobot' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/qch/dobot_ws/src/dobot/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/qch/dobot_ws/devel/lib;/opt/ros/kinetic/lib)
